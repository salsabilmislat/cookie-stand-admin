...
function LoginForm({submitHandler}) {
    ...
    return (
        ...
        <form className="flex flex-col w-1/2 gap-4 p-8 mx-auto my-4 text-center bg-emerald-300 border-2 border-emerald-500 rounded-lg text-md" onSubmit={e=>submitHandler(e,credintials)} method='post'>
            ...
            <button className="px-3 py-4 mt-8 uppercase bg-emerald-500 rounded text-green hover:bg-emerald-400 font-bold" type="submit">Sign In</button>
